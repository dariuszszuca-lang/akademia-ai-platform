...
const mockPosts = [
  {
    ...
    excerpt: "Platforma jest gotowa! Tutaj znajdziesz wszystkie materiały, nagrania i zadania z warsztatów. Zacznij od sekcji START TUTAJ w Materiałach, a potem przejdź do Przygotowania (Praca domowa). Do zobaczenia 15 kwietnia na spotkaniu online!",
    likes: 5,
    comments: 2,
    pinned: true,
  },
  {
    ...
    category: "Ogłoszenia",
    time: "2d",
    title: "Przygotowanie do warsztatu — co zrobić przed 15 kwietnia",
    excerpt: "Zanim spotkamy się online w środę 15 kwietnia, przejdź przez moduł Przygotowanie w sekcji Materiały. Znajdziesz tam zadania: profil przedsiębiorcy, persony, ofertę i konfigurację kont AI. To pozwoli nam od razu wejść w praktykę na warsztacie.",
    likes: 8,
    comments: 3,
    pinned: false,
  },
